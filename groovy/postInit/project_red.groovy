...
mods.jei.yeet(item('projectred-core:resource_item', 251))
mods.jei.yeet(item('projectred-core:resource_item', 252))
mods.jei.yeet(item('projectred-core:resource_item', 301))
mods.jei.yeet(item('projectred-core:resource_item', 600))
mods.jei.yeet(item('projectred-core:resource_item', 105))
mods.jei.yeet(item('projectred-core:resource_item', 104))
mods.jei.yeet(item('projectred-core:resource_item', 103))
mods.jei.yeet(item('projectred-core:resource_item', 102))
mods.jei.yeet(item('projectred-core:resource_item', 100))
mods.jei.yeet(item('projectred-core:resource_item', 101))
mods.jei.yeet(item('projectred-core:resource_item', 202))
mods.jei.yeet(item('projectred-core:resource_item', 201))
mods.jei.yeet(item('projectred-core:resource_item', 200))
mods.jei.yeet(item('projectred-core:resource_item', 300))
mods.jei.yeet(item('projectred-core:resource_item', 250))
mods.jei.yeet(item('projectred-core:resource_item', 400))
mods.jei.yeet(item('projectred-core:resource_item', 402))
mods.jei.yeet(item('projectred-core:resource_item', 401))
mods.jei.yeet(item('projectred-core:resource_item', 410))
mods.jei.yeet(item('projectred-core:resource_item', 420))
mods.jei.yeet(item('projectred-core:resource_item', 421))
mods.jei.yeet(item('projectred-core:drawplate'))
mods.jei.yeet(item('projectred-transmission:framed_wire', 34))
mods.jei.yeet(item('projectred-transmission:wire', 34))
mods.jei.yeet(item('projectred-core:resource_item', 312))
mods.jei.yeet(item('projectred-core:resource_item', 342))
