mods.jei.yeet(item('appliedenergistics2:fluix_block'))
mods.jei.yeet(item('appliedenergistics2:fluix_stairs'))
mods.jei.yeet(item('appliedenergistics2:fluix_slab'))
mods.jei.yeet(item('appliedenergistics2:material', 7))
mods.jei.yeet(item('appliedenergistics2:material', 8))
mods.jei.yeet(item('appliedenergistics2:material', 5))
mods.jei.yeet(item('appliedenergistics2:spatial_storage_cell_2_cubed'))
mods.jei.yeet(item('appliedenergistics2:spatial_storage_cell_16_cubed'))
mods.jei.yeet(item('appliedenergistics2:spatial_storage_cell_128_cubed'))
mods.jei.yeet(item('appliedenergistics2:material', 32))
mods.jei.yeet(item('appliedenergistics2:material', 33))
...
mods.gregtech.assembler.recipeBuilder()
  .inputs(ore('circuitEv')*4, item('appliedenergistics2:material', 56), item('appliedenergistics2:material', 24)*2, item('appliedenergistics2:material', 23)*2)
